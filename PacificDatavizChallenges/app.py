...
with st.sidebar:
    ...
    # Première colonne
    with col1:
        img = Image.open("./img/linkedin_icon.png")
...
if choice == "Accueil":
    ...
    *William Ernest Henley*
    ...
    with tab3:
        ...
        img = Image.open("./img/ressources.jpg")
        st.image(img)
