...
def modelisation():
   ...
   image_path = os.path.join(os.path.dirname(__file__), "../img", "paris_futur.jpg")
   ...
   with st.expander("Feature importances - Arbre de décision"):
       image = os.path.join(os.path.dirname(__file__), "../img", "FI - Arbre decision.png")
       image2 = os.path.join(os.path.dirname(__file__), "../img", "FI2 - Arbre decision.png")
   ...
   with st.expander("Feature importances - Random Forest"):
       image3 = os.path.join(os.path.dirname(__file__), "../img", "FI - RandomForest.png")
       image4 = os.path.join(os.path.dirname(__file__), "../img", "FI2 - RandomForest.png")
   ...
   with st.expander("Feature importances - Lasso"):
       image5 = os.path.join(os.path.dirname(__file__), "../img", "FI - Lasso.png")
       image6 = os.path.join(os.path.dirname(__file__), "../img", "FI2 - Lasso.png")
       img5 = Image.open(image5)
       img6 = Image.open(image6)
       st.image(img5, width=450)
       st.image(img6, width=450) 
     
   #Gradient Boosting
   with st.expander("Feature importances - GradientBoosting"):
       image7 = os.path.join(os.path.dirname(__file__), "../img", "FI - GradientBoosting.png")
       image8 = os.path.join(os.path.dirname(__file__), "../img", "FI2 - GradientBoosting.png")
   ...
   image_path = os.path.join(os.path.dirname(__file__), "../img", "projection_2060.png")
   img = Image.open(image_path)
   st.image(img)  
